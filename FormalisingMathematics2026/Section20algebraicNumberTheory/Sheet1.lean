...
-- This is how to make its ring of integers: note that it's a type.
example : Type :=
  RingOfIntegers K
...
-- As an exercise, try proving that `Q_sqrt_2` is an `add_comm_group` (you'll need to define `zero`
-- and `neg`),
